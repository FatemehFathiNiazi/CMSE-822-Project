...
std::vector<std::vector<double>> apply_pbc (int N,std::vector<std::vector<double>> &position, double l,double half_size_box){
...
double Calculation_Energy(int N,double epsilon,std::vector<std::vector<double>> &position,double sigma,double l){
    double energy=0;
...
std::vector<std::vector<double>> Calculation_Forces (int N,double epsilon,double sigma, std::vector<std::vector<double>> &position,double l){
